<template>
    <h1 class="wp-heading-inline">{{ __('Yabe Webfont', 'yabe-webfont') }}</h1>
    <div class="yabe-webfont-top-menu tw-p-2">
        <a href="https://rosua.org" target="_blank">Rosua.org</a> |
        <a href="https://rosua.org/blog/" target="_blank">{{ __('News', 'yabe-webfont') }}</a> |
        <a href="https://l.suabahasa.dev/EyJym" target="_blank">{{ __('Support', 'yabe-webfont') }}</a> |
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a class="nav-tab" href="https://webfont.yabe.land/docs" target="_blank">
            Docs
