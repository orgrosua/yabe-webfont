<template>
    ...
    <div class="tw-inline-flex tw-items-center tw-float-right">
        ...
        <a href="https://github.com/sponsors/suabahasa" target="_blank" class="tw-group page-title-action tw-flex tw-space-x-1 !tw-top-auto !tw-p-1 !tw-px-3 tw-items-center !tw-rounded-md tw-transition-[color,background-color,box-shadow,border-color] tw-ease-[cubic-bezier(0.33,1,0.68,1)] tw-duration-75">
