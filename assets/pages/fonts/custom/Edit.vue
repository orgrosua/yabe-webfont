<template>
    <span class="tw-mr-2 tw-text-2xl">» {{ __('Edit', 'yabe-webfont') }} </span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="autosave-info">
                                    Last edited on <span :title="new Date(item.updated_at * 1000)" class="tw-underline tw-decoration-dotted tw-text-gray-700">{{ ago(new Date(item.updated_at * 1000)) }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
