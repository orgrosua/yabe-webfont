<template>
    <span class="mr-2 text-2xl">» {{ __('Edit', 'yabe-webfont') }} </span>
    ...
    <div id="poststuff">
        <form id="post-body" @submit="sendForm" class="metabox-holder columns-2 !columns-auto">
            ...
            <div id="postbox-container-2" class="postbox-container mt-3">
                ...
                <div>
                    <table id="post-status-info" class="border border-solid border-[#c3c4c7]">
                        <tbody>
                            <tr>
                                <td class="pl-2">
                                ...
                                <td class="autosave-info">
                                    Last edited on <span :title="new Date(item.updated_at * 1000)" class="underline decoration-dotted text-gray-700">{{ ago(new Date(item.updated_at * 1000)) }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
