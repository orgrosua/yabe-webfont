                                ...
                                <div id="minor-publishing">
                                    <div id="misc-publishing-actions" class="tw-py-1.5">
                                        <div class="misc-pub-section">
                                            <!-- Font Info: Rank -->
                                            <div class="tw-py-1.5 tw-flex tw-items-center">
                                                <svg class="tw-h-4 tw-w-4 tw-text-[#8c8f94] tw-fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            <!-- Font Info: Category -->
                                            <div class="tw-py-1.5 tw-flex tw-items-center">
                                                <svg class="tw-h-4 tw-w-4 tw-text-[#8c8f94] tw-fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            <!-- Font Info: Version -->
                                            <div class="tw-py-1.5 tw-flex tw-items-center">
                                                <svg class="tw-h-4 tw-w-4 tw-text-[#8c8f94] tw-fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            <!-- Font Info: Style -->
                                            <div class="tw-py-1.5 tw-flex tw-items-center">
                                                <svg class="tw-h-4 tw-w-4 tw-text-[#8c8f94] tw-fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
...
const cssPreviewStylesheet = computed(() => {
    ...
    css = css.replace(/url\(\'.*\'\)/g, `url('LOCAL_FILE_URL')`);
