<template>
    <span class="mr-2 text-2xl">» {{ __('Edit Google Fonts', 'yabe-webfont') }} </span>
            ...
            <div id="post-body-content">
                ...
                <div class="postarea wp-editor-expand">
                    <div id="wp-content-wrap" class="wp-core-ui mt-8">
                        ...
                        <div class="flex items-center space-x-4 mt-8 mb-3">
                            <h3 class="flex-1">Variants <input v-model="selectAll" class="" type="checkbox" title="(De)select All" /></h3>

                            <div class="flex items-center space-x-4 border border-solid py-2 px-2 !border-gray-300">
                            ...
                            <div class="submitbox" id="submitpost">
                                ...
                                <div id="major-publishing-actions">
                                    <div id="delete-action">
                                        <a :class="{ 'cursor-wait': busy.isBusy }" class="text-red-700 underline cursor-pointer hover:text-red-800" @click="doDelete">
