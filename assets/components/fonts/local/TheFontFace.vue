...
function toggleConfirmDeleteBtn() {
    isShowConfirmDeleteBtn.value = !isShowConfirmDeleteBtn.value;

    if (isShowConfirmDeleteBtn.value) {
        setTimeout(() => {
