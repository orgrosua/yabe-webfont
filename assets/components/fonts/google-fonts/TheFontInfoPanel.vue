            ...
            <div class="postbox-header">
                <h2 class="">
                    ...
                    <a v-if="fontData" :href="`https://fonts.google.com/specimen/${fontData.slug.replaceAll('-', '+')}`" target="_blank">
                        <font-awesome-icon :icon="['far', 'arrow-up-right-from-square']" class="w:15 h:15" />
                    </a>
                </h2>
            </div>
            <div class="inside">
                        ...
                        <div id="misc-publishing-actions" class="py:6">
                            <div class="misc-pub-section">
                                ...
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'ranking-star']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <!-- Font Info: Category -->
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'font']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <!-- Font Info: Version -->
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'code-pull-request']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'calendar-pen']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <!-- Font Info: Style -->
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'paintbrush']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <!-- Font Info: Designers -->
                                <div class="py:6 flex align-items:center">
                                    <font-awesome-icon :icon="['fas', 'hand-holding-magic']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
                                ...
                                <div v-if="fontData?.axes.length" class="py:6 flex flex:col">
                                    <div class="flex align-items:center">
                                        <font-awesome-icon :icon="['fas', 'gear']" class="h:16 w:16 flex-shrink:0 fg:#8c8f94 fill:current" />
