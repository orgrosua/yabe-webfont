...
Tags: bricks builder, google fonts
...
Yabe Webfont help you to self-hosting the Google Fonts and register the font to the [Bricks](https://bricksbuilder.io)' Custom Font with ease.
...
* All Google Fonts is available — Type on the search box to find the Google Fonts you want to self-host.
* Download only what you need — Select the font subsets, font weights and the file format.
